...
namespace nettoyageEncaissements
{
    public partial class Form1 : Form
    {
        ...
        private void buttonDemarrage_Click(object sender, EventArgs e)
        {
            ...
            ///
            /// Deux cas possibles :
            /// _ Les encaissements en trop se sont présentés sur une base seule suite à une migration de version par exemple :
            ///     * dans ce cas le net à payer de l'affaire est négatif et mais le montant d'acompte reçu semble pourtant correspondre à la somme des règlements présents à l'écran
            /// _ Les encaissements en trop se sont présentés sur deux bases suite à la mise en place d'une synchronisation, mais ne se manifestent pas de la même manière
            /// sur la base client et la base maître :
            ///     * dans le cas de la base client : le net à payer de l'affaire est négatif et mais le montant d'acompte reçu semble pourtant correspondre à la somme des règlements
            ///     présents à l'écran.
            ///     * dans le cas de la base maître : le net à payer est nul, et le montant de l'acompte reçu est inférieur à la somme des règlements perçus.
            ///     
            
            ///
            /// Gestion du cas de gestion, une base seule ou deux bases synchronisées, selon le choix donné par la case à cocher
            /// 
            //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            {
                monFicLog.Log("Traitement sur la base " + comboBoxBaseServeur.Text + " pour récupérer la liste des factures dont le net à payer est inférieur à 0 mais dont le montant d'acompte est tout de même égal à la somme des encaissements versés.", ficLog);
            }

            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ///
            /// La requête est la même pour une base seule que pour la base de données client synchronisée
            /// 
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ///
            /// Initialisation des paramètres de connexion en fonction du choix de l'utilisateur
            /// 
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            using (chaineConnexionListeBases = new OdbcConnection(paramConnexion))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        monFicLog.Log("Erreur de connexion ODBC lors de la récupération des affaires pour la base " + comboBoxBaseServeur.Text + ".", ficLog);
                    }
                    else
                    {
                    ...
                    if (chkBxBase.Checked)
                    {
                        MessageBox.Show("Erreur à la connexion à la base " + comboBoxBaseServeur.Text + ".");
                    }
                    else
                    {
            ...
            { 
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ///
                /// Dans le cas de bases synchronisées, on croise les deux listes d'affaires
                /// 
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ///
                /// Traitement côté base serveur : on récupère la liste des encaissements à supprimer en fonction de chaque affaires
                /// et du nombre de doublons, pour lequel on limite la récupération à un seul enregistrement
                /// 
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                foreach (Affaire affaire in listAffairesO)
                {
                    ...
                    using (chaineConnexionListeBases = new OdbcConnection(paramConnexion))
                    {
                        ...
                        {
                            monFicLog.Log("Erreur de connexion ODBC à la récupération de la liste des encaissements sur la base serveur.", ficLog);
                            monFicLog.Log(ex.ToString(), ficLog);
                            mesTests = false;
                            MessageBox.Show("Erreur à la connexion à la base serveur lors de la récupération de la liste des encaissements en erreur.");
                        }
                        finally
                        {
                            // Exécution si pas d'exception
                            if (mesTests)
                            {
                                ...
                                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                ///
                                /// Traitement côté base serveur : on indique quel encaissement doit être supprimé, dans la table des encaissements
                                /// ainsi que dans la table des enregistrements mémorisés pour les contrôles de gestion
                                /// 
                                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ///
                /// Traitement côté base client : on récupère la liste des encaissements à partir de ceux déjà traités côté serveur
                /// 
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ///
                paramConnexion = "Driver={PostgreSQL UNICODE};Server=" + textBoxAdrClient.Text + ";Port=" + textBoxPortClient.Text + ";Database=" + comboBoxBaseClient.Text + ";Uid=" + loginPG + ";Pwd=" + passPG + ";";
                ...
                using (chaineConnexionListeBases = new OdbcConnection(paramConnexion))
                {
                    ...
                    finally
                    {
                        ...
                        if (mesTests)
                        {
                            ...
                            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                            ///
                            /// Traitement côté base client : on indique quel encaissement doit être supprimé, dans la table des encaissements
                            /// ainsi que dans la table des enregistrements mémorisés pour les contrôles de gestion
                            /// 
                            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                            ///
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ///
            /// Traitement de la suppression dans le cas d'une base unique
            /// 
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            else
            {
                ...
                foreach (Affaire affaire in listAffairesClient)
                {
                    requetes = @"SELECT  e1.id_encaissement AS ID, e1.uid AS UID, e1.montant, e1.dtencaissement, (SELECT COUNT(*)
                            FROM encaissement e2
                            WHERE e2.doc_id = e1.doc_id
                    ...
                    using (chaineConnexionListeBases = new OdbcConnection(paramConnexion))
                    {
                        ...
                        {
                            monFicLog.Log("Erreur de connexion ODBC à la récupération de la liste des encaissements sur la base " + comboBoxBaseServeur.Text + ".", ficLog);
                            monFicLog.Log(ex.ToString(), ficLog);
                            mesTests = false;
                            MessageBox.Show("Erreur à la connexion à la base serveur lors de la récupération de la liste des encaissements en erreur.");
                        }
